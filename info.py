...
PICS = (environ.get('PICS', 'https://telegra.ph/file/462b0bbd3623b54672f75.jpg')).split() #SAMPLE PIC
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002456671995')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Autofilter:Autofilter@autofilter.i1riqhu.mongodb.net/?retryWrites=true&w=majority&appName=autofilter")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/SK_MoviesOffl') # Support Chat Link Without https:// or @
